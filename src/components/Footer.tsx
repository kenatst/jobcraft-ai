      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            L'IA qui décroche tes entretiens. CV, lettres de motivation et coaching sur mesure.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5">
            ...
            <li><a href="#tarifs" className="text-sm text-foreground/70 hover:text-primary transition-colors">Tarifs</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5">
            ...
            <li><Link to="/" className="text-sm text-foreground/70 hover:text-primary transition-colors">Guide ATS</Link></li>
          </ul>
        </div>
